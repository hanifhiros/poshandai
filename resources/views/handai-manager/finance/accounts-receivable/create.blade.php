...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="mb-6">
        <a href="{{ route('manager.finance.ar.index') }}" class="text-sm text-green-600 hover:text-green-800 font-medium">
            <i class="ti ti-arrow-left mr-1"></i> Kembali ke Daftar Piutang
        </a>
        <h1 class="text-2xl font-bold text-gray-800 mt-2">Tambah Piutang (AR)</h1>
    </div>
    ...
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 max-w-xl">
        <form method="POST" action="{{ route('manager.finance.ar.store') }}">
            @csrf
            <div class="space-y-4">
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="description" value="{{ old('description') }}" required
                           class="mt-1 block w-full text-sm border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500"
                           placeholder="Penjualan kredit, dll.">
                </div>
            ...
            <div class="flex justify-end gap-2 mt-6">
                <a href="{{ route('manager.finance.ar.index') }}" class="px-4 py-2 text-sm text-gray-600 hover:text-gray-800">Batal</a>
