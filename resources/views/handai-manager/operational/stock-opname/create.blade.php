...
<div class="py-5 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto"
    ...
    <form action="{{ route('manager.operational.stock-opname.store') }}" method="POST"
        ...
        {{-- Items Table --}}
        <div class="mt-6">
            <h3 class="text-sm font-semibold text-gray-800 mb-3">Daftar Bahan â€” Masukkan stok aktual</h3>
        ...
        <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
            <a href="{{ route('manager.operational.stock-opname.index') }}"
               class="px-4 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-100 hover:bg-gray-100 transition">â† Batal</a>
            <button type="submit"
