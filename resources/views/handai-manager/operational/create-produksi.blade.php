        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                        <label class="cpd-label">Pilih PIC</label>
                        ...
                        <p class="text-[11px] text-gray-400 mt-1">Pilih satu per satu, lalu tekan Tambah.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <div x-show="picIds.length === 0" class="text-[12px] text-gray-400 mt-2">Belum ada PIC.</div>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3">
                                ...
                                <div x-show="line.type === 'finished'" x-cloak>
                                    ...
                                    <select :name="`production_lines[${index}][product_variants_id]`" x-model="line.product_variants_id" class="cpd-select" :disabled="line.type !== 'finished'">
                                        ...
                                        <option value="{{ $variant->id }}">{{ $variant->product->name }} — {{ str_replace('â€”', '—', $variant->options->pluck('name')->join(', ')) }}</option>
                                        @endforeach
                                    </select>
                                </div>
